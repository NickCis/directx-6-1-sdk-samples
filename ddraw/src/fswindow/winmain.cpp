...
IDirectDraw4               *g_pDD = NULL;       // DirectDraw object
IDirectDrawSurface4        *g_pDDSPrimary = NULL;  // DirectDraw primary surface
IDirectDrawSurface4        *g_pDDSBack = NULL;  // DirectDraw back surface
        ...
        int nCmdShow)
{
    ...
    hRet = DirectDrawCreate(gpSelectedDriverGUID, &pDD, NULL);
    if (hRet != DD_OK)
