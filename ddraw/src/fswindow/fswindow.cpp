...
// Local definitions
//-----------------------------------------------------------------------------
static IDirectDraw4        *ddObject = NULL;
static IDirectDrawSurface4 *ddFrontBuffer = NULL;
static IDirectDrawSurface4 *ddBackBuffer = NULL;
...
//-----------------------------------------------------------------------------
void 
FSWindow_Init(HWND hwndApp, IDirectDraw4 *dd, IDirectDrawSurface4 *FrontBuffer,
