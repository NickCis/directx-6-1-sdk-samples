...
Path
====
  Source: Mssdk\Samples\Multimedia\Dmusic\Src\EchoTool

  Executable: Mssdk\Samples\Multimedia\DMusic\Bin

User's Guide
============
  Select a an option button to change the delay of the echoes. Click the
...
=================
  ...
  functions are called from Main.cpp. Echotool.cpp contains the tool code. 

  For more information, see Tutorial 2: Using Tools in the DirectX help file.
